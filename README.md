...
-  File Uploads: Multer-based movie uploads (authMiddleware/multer.js) saved to uploads/movies/.
-  Routes: Admin, user, and movie routes in routes.
-  Simple data store: Example users.json files provided for quick testing.
